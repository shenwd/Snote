...
public class RecordActivity extends BaseMainActivity {
...
//        mediaPlayer = new MediaPlayer();
        ...
        flRecord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mediaRecorder.getRecordState() == SMediaRecorder.RECORD_START) {
                    ToastUtils.showShort(RecordActivity.this, "暂停");
                    mediaRecorder.stop();
                    recordPlay = false;
                    ivPlay.startAnimation(showAnim);
                    ivPause.startAnimation(hideAnim);
                } else {
                    ToastUtils.showShort(RecordActivity.this, "开始");
                    recordNameSuffic++;
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setResult(CompileActivity.REQUEST_RECORD, returnIntent);
                finish();
            }
        });
        ...
        if (bundle != null) {
            ...
            ToastUtils.showShort(this, "无效bundle");
        }
    ...
    private void deleteRecordFile(String recordName) {
        if (!recordDir.exists()) {
            ToastUtils.showShort(this, "录音文件夹不存在");
            return;
        }
        ...
        switch (requestCode) {
            case PERMISSON_SDCARD: {
                ...
                if (grantResults.length > 0
                    ...
                    ToastUtils.showShort(this, "你拒绝了相关权限，无法使用服务");
                    ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.RECORD_AUDIO, Manifest.permission.WRITE_EXTERNAL_STORAGE}, PERMISSON_SDCARD);
    ...
    private void checkFile(String recordName, String suffic) {
        if (recordName != null && !TextUtils.isEmpty(recordName)) {
            ...
            ToastUtils.showShort(this, "无效路径");
        }
    }
